...
//Retorna um valor com se fosse um cache
const UseMemo = () => {
    ...
    //Retonar o valor da soma de n1 e n2, e so calcula quando n1 ou n2 mudar
    const result : number = useMemo(() => sum(n1, n2), [n1, n2])
